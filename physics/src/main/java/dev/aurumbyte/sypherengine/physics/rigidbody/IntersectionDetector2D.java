...
public class IntersectionDetector2D {
    ...
    public static boolean pointInBox2D(Vector2 point, Box2DCollider box) {
        ...
        return pointLocalBoxSpace.xPos <= max.xPos
                && min.xPos <= pointLocalBoxSpace.xPos
                && pointLocalBoxSpace.yPos <= max.yPos
                && min.yPos <= pointLocalBoxSpace.yPos;
    }
    ...
    public static boolean raycast(CircleCollider circle, Ray2D ray, RaycastResult result) {
        ...
        if (result != null) {
            Vector2 point = new Vector2(ray.getOrigin()).add(new Vector2(ray.getDirection()).multiply(t));
    ...
    public static boolean raycast(Box2DCollider box, Ray2D ray, RaycastResult result) {
        ...
        Vector2 f = new Vector2(xAxis.dot(ray.getDirection()), yAxis.dot(ray.getDirection()));
    ...
    public static boolean circleColliderAndBox2DCollider(CircleCollider circleCollider, Box2DCollider box) {
        ...
        Vector2 r = new Vector2(circleCollider.getCenter())
                .subtract(box.getRigidBody().getPosition());
