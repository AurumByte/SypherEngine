...
public class Collisions {
    public static CollisionManifold findCollisionFeatures(Collider2D a, Collider2D b) {
        if (a instanceof CircleCollider c1 && b instanceof CircleCollider c2) return findCollisionFeatures(c1, c2);
    ...
    public static CollisionManifold findCollisionFeatures(CircleCollider a, CircleCollider b) {
        ...
        Vector2 contactPoint = new Vector2(a.getCenter()).add(new Vector2(normal).multiply(distanceToPoint));
