module io.github.sypherengine.core {
    ...
    opens dev.aurumbyte.sypherengine.core.config to javafx.fxml;

    exports dev.aurumbyte.sypherengine.core.components;
    opens dev.aurumbyte.sypherengine.core.components to javafx.fxml;

    exports dev.aurumbyte.sypherengine.core.components.scene;
    opens dev.aurumbyte.sypherengine.core.components.scene to javafx.fxml;

    exports dev.aurumbyte.sypherengine.core.components.camera;
    opens dev.aurumbyte.sypherengine.core.components.camera to javafx.fxml;

    exports dev.aurumbyte.sypherengine.core.ui;
    opens dev.aurumbyte.sypherengine.core.ui to javafx.fxml;
